...
<!-- [Patrick] TODO F#-Grundlagen erwartet... -->
```fsharp
let homer = {
    FirstName = "Homer"
    LastName = "Simpson"
...
Im Gegensatz zum `Person`-Typ handelt es sich hier um sogenannte [Single-Case Discriminated Unions (SCDU)](https://fsharpforfunandprofit.com/posts/designing-with-types-single-case-dus/). Eine Discrimanted Union wird auch als Oder-Typ bezeichnet. Im Falle einer SCDU gibt es lediglich einen Wert, der als Wrapper fungiert um das Primitive-Obsession Antipattern zu umgehen.
...
<!-- [Patrick] muss ich mir noch uberlegen, ob ich das detailiert erklaere. Ist normale F# Syntax...  -->
...
<!-- [Patrick] TODO Evtl muss ich noch an meinem Beispielcode arbeiten, damit klar wird, warum man das machen kann -->
## Neue Anforderungen
...
<!-- [Patrick] TODO Beipiel / Fragestellung besser rausarbeiten... -->
